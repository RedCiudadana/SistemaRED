...
var finalizadoraw=document.getElementById("pendiente");

var iniciar=iniciarraw.innerHTML;
var proceso=procesoraw.innerHTML;
var finalizado=finalizadoraw.innerHTML;

iniciar=parseInt(iniciar);
proceso=parseInt(proceso);
finalizado=parseInt(finalizado);
...
var KTApexChartsDemo = function () {
	...
	var _demo11 = function () {
		...
		var options = {
			series: [iniciar, proceso, finalizado],
            labels: ['Por Iniciar','En Proceso','Finalizado'],
			chart: {
				width: 380,
				type: 'donut',
			},
