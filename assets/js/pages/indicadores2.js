...
var KTWidgets = function () {
    ...
    var indicador = document.querySelectorAll("[id='indicador']");
    var actual = document.querySelectorAll("[id='actual']");
    var meta = document.querySelectorAll("[id='meta']");
    ...
    var _initMixedWidget4 = function () {
        ...
        var options = {
            series: [{
                name: 'Meta',
                data: [metas1,metas2,metas3,metas4,metas5,metas6,metas7,metas8,metas9,metas10]
            }, {
                name: 'Resultado Total',
                data: [resul1,resul2,resul3,resul4,resul5,resul6,resul7,resul8,resul9,resul10]
            }],
            chart: {
                type: 'bar',
                height: height,
